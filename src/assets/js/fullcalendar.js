...
var DayGrid = /** @class */ (function (_super) {
    ...
    DayGrid.prototype.renderNumberCellHtml = function (date) {
       ...
       // html += '<a href="rota-new.html" id="register-btn" type="button"><button><p>Register</p></button></a>';
       // html += '</div>'
        html += '</td>';
        return html;
    };
...
var DayGridEventRenderer = /** @class */ (function (_super) {
    ...
    DayGridEventRenderer.prototype.fgSegHtml = function (seg, disableResizing) {
        ...
        titleHtml =
            '<span class="fc-title" style="font-size:16px ! important;  font-family: Open Sans, sans-serif;">' +
                (util_1.htmlEscape(eventDef.title || '') || '&nbsp;') + // we always want one line of height
                '</span>'+
                '<div style="text-align: center;">'+
               '<br><button  onClick="register()" style="width:100%"><p>Register</p></button>' +
               '</div>';
        return '<a class="' + classes.join(' ') + '"' +
            (eventDef.url ?
                ' href="' + util_1.htmlEscape(eventDef.url) + '"' :
